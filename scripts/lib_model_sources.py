...
def infer_minimax_base(repo_id: str, filename: str) -> str | None:
    text = f"{repo_id} {filename}".lower()
    if "minimax_h3" in text or "minimaxh3" in text or "minimax-h3" in text or ("minimax" in text and "h3" in text):
        return "MiniMax-H3"
    if "minimax" in text:
        return "MiniMax-H3"
    return None
