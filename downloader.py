    ...
    try:
        ...
        def run_file_download_with_cancel(download_kwargs: dict) -> str:
            ...
            script = (
                ...
                "result = {}\n"
                "try:\n"
                "    # Stage 1: huggingface_hub download with token\n"
